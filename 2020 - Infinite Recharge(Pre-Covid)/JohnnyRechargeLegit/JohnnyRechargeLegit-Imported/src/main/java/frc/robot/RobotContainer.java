...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    openDumper.whenPressed(() -> mDumpMechanism.dumpCells(true));          //Editeddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
    final JoystickButton closeDumper = new JoystickButton(mSecondaryController, Button.kY.value);
    closeDumper.whenPressed(() -> mDumpMechanism.dumpCells(false));         //Editeddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
    ...
    final JoystickButton spinToColorButton = new JoystickButton(mDriveController, Button.kB.value);
